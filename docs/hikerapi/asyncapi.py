...
class AsyncClient(BaseAsyncClient):
    ...
    async def user_clips_chunk_v1(self, user_id: str, end_cursor: Optional[str] = None) -> Dict:
    ...
    async def user_stories_by_username_v1(self, username: str, amount: Optional[int] = None) -> Dict:
    ...
    async def user_highlights_v1(self, user_id: str, amount: Optional[int] = None) -> Dict:
        '''User Highlights. Get user highlights'''
        params = {"user_id": user_id, "amount": amount}
        return await self._request("get", "/v1/user/highlights", params=params)

    async def user_highlights_by_username_v1(self, username: str, amount: Optional[int] = None) -> Dict:
        '''User Highlights By Username. Get user highlights by username'''
        params = {"username": username, "amount": amount}
        return await self._request("get", "/v1/user/highlights/by/username", params=params)
    ...
    async def fbsearch_topsearch_hashtags_v1(self, query: str) -> Dict:
        ...
        params = {"query": query}
        return await self._request("get", "/v1/fbsearch/topsearch/hashtags", params=params)
